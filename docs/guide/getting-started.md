...
> New here? See [Why `afs new` instead of `func init`?](https://github.com/yeongseon/azure-functions-scaffold-python/blob/main/README.md#why-afs-new-instead-of-func-init) in the README for context on how this scaffolder differs from Azure Functions Core Tools.
