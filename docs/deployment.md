...
You know Python and pip. You have used the `afs` CLI to scaffold a project locally (see [README](https://github.com/yeongseon/azure-functions-scaffold-python/blob/main/README.md)).
